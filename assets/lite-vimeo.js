...
export class LiteVimeoEmbed extends HTMLElement {
    ...
    addIframe() {
        if (!this.iframeLoaded) {
            ...
            const srcUrl = new URL(`/video/${this.videoId}?${apValue}&loop=1&autopause=false${muted}&pip=0${controlsValue}&#t=${this.videoStartAt}`, "https://player.vimeo.com/");
